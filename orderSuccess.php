...
$result = $db->query("SELECT r.*, c.name, c.last_name, c.email, c.phone FROM orders as r LEFT JOIN users as c ON c.id = r.customer_id WHERE r.id = ".$_REQUEST['id']); 
...
<!-- alert end -->
 <div class="bg-white pb-4 px-4 rounded-md w-full">
      ...
      <div class="flex justify-between w-full pt-6 ">
        <p class="ml-3 text-xl text-gray-700"> ORDER STATUS</p>
      </div>
      <div class="lg:flex-col md:flex sm:flex text-gray-700 ord-addr-info">
      <?php if(!empty($orderInfo)){ ?>
      <div class="hdr text-md ml-3  ">Order Info</div>
    ...
    <div class="overflow-x-auto mt-6">
      ...
      <table class="table-auto border-collapse w-full">
        <thead>
          <tr class="rounded-lg text-sm font-medium text-gray-700 text-left" style="font-size: 0.9674rem">
            <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Product</th>
            <th class="px-4 py-2 " style="background-color:#f8f8f8">Price</th>
            <th class="px-4 py-2 " style="background-color:#f8f8f8">QTY</th>
            <th class="px-4 py-2 " style="background-color:#f8f8f8">Sub Total</th>
          </tr>
        </thead>
        ...
        <?php 
          ...
          <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
            <td class="px-4 py-4"><?php echo $item["name"]; ?></td>
      ...
      <div class="overflow-x-auto mt-6">
                ...
                <table class="table-auto border-collapse w-full">
                  <thead>
                    <tr class="rounded-lg text-sm font-medium text-gray-700 text-left" style="font-size: 0.9674rem">
                    <th class="px-4 py-2 " style="background-color:#f8f8f8">Buyer Name</th>
                      <th class="px-4 py-2 " style="background-color:#f8f8f8">Email</th>
                      <th class="px-4 py-2 " style="background-color:#f8f8f8">Phone</th>
                      <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Reference ID</th>
                      <th class="px-4 py-2 " style="background-color:#f8f8f8">Placed On</th>
                      <th class="px-4 py-2 " style="background-color:#f8f8f8">Total</th>
    ...
    <?php } else{ ?>
      ...
      <?php } ?>
  	 <div id="pagination" class="w-full flex justify-center border-t border-gray-100 pt-4 items-center">
        ...
        <p class="leading-relaxed cursor-pointer mx-2 text-blue-600 hover:text-blue-600 text-sm"></p>
        <p class="leading-relaxed cursor-pointer mx-2 text-sm hover:text-blue-600" ></p>
        <p class="leading-relaxed cursor-pointer mx-2 text-sm hover:text-blue-600"></p>
        <p class="leading-relaxed cursor-pointer mx-2 text-sm hover:text-blue-600"></p>
