...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){ 
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){ 
        ...
        $redirectLoc = $insertItem?'viewcart.php':'loggedin.php'; 
        ...
        if(empty($errorMsg)){ 
            ...
            $insertCust = $db->query("INSERT INTO users (name, last_name, email, phone, address) VALUES ('".$name."', '".$last_name."', '".$email."', '".$phone."', '".$address."')"); 
